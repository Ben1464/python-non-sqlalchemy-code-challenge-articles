...
class Magazine:
    ...
    def contributing_authors(self):
        ...
        for article in self._articles:
            if article.author not in author_articles:
                author_articles[article.author] = 0
            author_articles[article.author] += 1
        contributors = [author for author, count in author_articles.items() if count > 2]
